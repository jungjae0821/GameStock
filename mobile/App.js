...
import { Alert, Linking, Modal, SafeAreaView, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View, useColorScheme } from 'react-native';
...
const TEXT = {
  ja: {
    ...
    '가격 추이': '価格推移', '가격 데이터 없음': '価格データなし', '일별 시세 (시가 · 종가 · 거래량)': '日別相場（始値・終値・出来高）', '시가': '始値', '종가': '終値',
  ...
  en: {
    ...
    '가격 추이': 'Price history', '가격 데이터 없음': 'No price data', '일별 시세 (시가 · 종가 · 거래량)': 'Daily prices (open · close · volume)', '시가': 'Open', '종가': 'Close',
